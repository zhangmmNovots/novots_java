...
*/
@Service
public class DeleteRevenueRecognitionService {
    ...
    public JSONObject processMainExecute(String paramsJson) throws BusinessException {
        ...
        paramsJson = StartEvent_1wj0yk1p62396079(paramsJson);
        //获取流程返回的结果
    ...
    public String StartEvent_1wj0yk1p62396079(String paramsJson) throws BusinessException {
        log.info("========执行开始方法=======");
        String taskName = "开始事件";
        String processName = "删除收入确认";
        String errorSuffix = "[" + processName + "-" + taskName + "]";
        try{
            paramsJson = Activity_0u8fygp(paramsJson);
            return paramsJson;
    ...
    public String Activity_0u8fygp(String paramsJson) throws BusinessException {
        log.info("========执行数据删除方法=======");
        ...
        try {
            ...
            String returnStr = JSON.toJSONString(uvsvApplicationRevenuService.Activity_0u8fygp(paramMap));
            ...
            //获取返回数据存在的key值
            String resultKey = "Activity_0u8fygp";
