...
*/
@Service
public class QueryPrimaryDirectoryService {
    ...
    public JSONObject processMainExecute(String paramsJson) throws BusinessException {
        ...
        paramsJson = StartEvent_1wj0yk1p62344d68(paramsJson);
        //获取流程返回的结果
    ...
    public String StartEvent_1wj0yk1p62344d68(String paramsJson) throws BusinessException {
        log.info("========执行开始方法=======");
        String taskName = "开始事件";
        String processName = "查询一级目录";
        String errorSuffix = "[" + processName + "-" + taskName + "]";
        try{
            paramsJson = Activity_0cc1d0p(paramsJson);
            return paramsJson;
    ...
    public String Activity_0cc1d0p(String paramsJson) throws BusinessException {
        log.info("========执行数据查询方法=======");
        ...
        try {
            ...
            //获取返回数据存在的key值
            String resultKey = "Activity_0cc1d0p";
            //处理请求参数
            ...
            String returnStr = JSON.toJSONString(uvsvSService.Activity_0cc1d0p(paramMap));
