...
public class GenerateTemplateService {
    ...
    public JSONObject processMainExecute(String paramsJson) throws BusinessException {
        ...
        paramsJson = StartEvent_1wj0yk1p62415fef(paramsJson);
        //获取流程返回的结果
    ...
    public String StartEvent_1wj0yk1p62415fef(String paramsJson) throws BusinessException {
        log.info("========执行开始方法=======");
        String taskName = "开始事件";
        String processName = "生成模板";
        String errorSuffix = "[" + processName + "-" + taskName + "]";
        try{
            paramsJson = Activity_0q15gn6(paramsJson);
            return paramsJson;
    ...
    public String Activity_0q15gn6(String paramsJson) throws BusinessException {
        log.info("========执行生成模板方法=======");
        String taskName = "生成模板";
        String processName = "生成模板";
        String errorSuffix = "[" + processName + "-" + taskName + "]";
        try {
            DocumentContext paramsJsonContext = JsonPath.parse(paramsJson);
            //下载的文件名称
            String downFileName = "模板生成";
            // 列头
            String[] headers = {"收入金额","所属月份"};
            ...
            downFileMap.put("columns", null);
            downFileMap.put("dataList", new ArrayList<>());
            String resultKey = "Activity_0q15gn6";
            ...
            log.error("处理失败", e);
            throw new BusinessException("生成模板处理失败" + errorSuffix, e);
        }
    }
    public String Event_18ucyuc(String paramsJson) throws BusinessException {
        ...
        try {
            ...
            jsonObject0.put("keyName", "model");
            jsonObject0.put("keyPath", "$.data.Activity_0q15gn6");
