...
public class QueryAuthorityService {
    ...
    public JSONObject processMainExecute(String paramsJson) throws BusinessException {
        ...
        paramsJson = StartEvent_1wj0yk1p62451569(paramsJson);
        //获取流程返回的结果
    ...
    public String StartEvent_1wj0yk1p62451569(String paramsJson) throws BusinessException {
        log.info("========执行开始方法=======");
        String taskName = "开始事件";
        String processName = "查询权限";
        String errorSuffix = "[" + processName + "-" + taskName + "]";
        try{
            paramsJson = Activity_14crfon(paramsJson);
            return paramsJson;
    ...
    public String Activity_14crfon(String paramsJson) throws BusinessException {
        log.info("========执行数据查询方法=======");
        ...
        try {
            ...
            //获取返回数据存在的key值
            String resultKey = "Activity_14crfon";
            //处理请求参数
            ...
            String returnStr = JSON.toJSONString(uvsvJurisdictionService.Activity_14crfon(paramMap));
    ...
    public String Event_18ucyuc(String paramsJson) throws BusinessException {
        ...
        try {
            ...
            jsonObject0.put("keyName", "query_limit");
            jsonObject0.put("keyPath", "$.data.Activity_14crfon");
