...
import com.weilaios.iqxceqhnhubt.da.mapper.UvsvEntityVeptMapper;
 ...
 */
@Service
public class UvsvEntityVeptServiceImpl extends ServiceImpl<UvsvEntityVeptMapper, UvsvEntityVept> implements UvsvEntityVeptService {

    @Autowired
    private UvsvEntityVeptMapper uvsvEntityVeptMapper;
    @Autowired
