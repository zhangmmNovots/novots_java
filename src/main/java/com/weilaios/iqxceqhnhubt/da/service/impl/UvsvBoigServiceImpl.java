...
import com.weilaios.iqxceqhnhubt.da.mapper.UvsvBoigMapper;
 ...
 */
@Service
public class UvsvBoigServiceImpl extends ServiceImpl<UvsvBoigMapper, UvsvBoig> implements UvsvBoigService {

    @Autowired
    private UvsvBoigMapper uvsvBoigMapper;
    @Autowired
