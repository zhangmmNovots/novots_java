...
import com.weilaios.iqxceqhnhubt.da.mapper.UvsvBackgroundUserMapper;
 ...
 */
@Service
public class UvsvBackgroundUserServiceImpl extends ServiceImpl<UvsvBackgroundUserMapper, UvsvBackgroundUser> implements UvsvBackgroundUserService {

    @Autowired
    private UvsvBackgroundUserMapper uvsvBackgroundUserMapper;
    @Autowired
