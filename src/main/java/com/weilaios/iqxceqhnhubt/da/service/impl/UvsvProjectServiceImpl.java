...
import com.weilaios.iqxceqhnhubt.da.mapper.UvsvProjectMapper;
 ...
 */
@Service
public class UvsvProjectServiceImpl extends ServiceImpl<UvsvProjectMapper, UvsvProject> implements UvsvProjectService {

    @Autowired
    private UvsvProjectMapper uvsvProjectMapper;
    @Autowired
