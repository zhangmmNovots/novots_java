...
public class QueryPrimaryDirectoryController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private QueryPrimaryDirectoryService queryPrimaryDirectoryService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p62344d68e4b0be5bec537147")
    public Result p62344d68e4b0be5bec537147Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = queryPrimaryDirectoryService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
