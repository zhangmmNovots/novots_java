...
public class LoginAuthenticationInterfaceController {
    ...
    * @return
    */
    @PostMapping(value = "/v1/p622e9f44e4b00618c34d397b")
    public Result p622e9f44e4b00618c34d397bDo(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            BeeUtils.isEmpty("用户名", paramMapList.get("interface_user"));
            //组装流程执行的系统默认参数
            ...
            //调用执行流程方法
            JSONObject returnDataJson = loginAuthenticationInterfaceService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
