...
public class DefaultProcessSpovController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private DefaultProcessSpovService defaultProcessSpovService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p62451b14e4b02961f8303394")
    public Result p62451b14e4b02961f8303394Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = defaultProcessSpovService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
