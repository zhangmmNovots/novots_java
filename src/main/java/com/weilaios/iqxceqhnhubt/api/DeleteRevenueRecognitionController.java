...
public class DeleteRevenueRecognitionController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private DeleteRevenueRecognitionService deleteRevenueRecognitionService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p62396079e4b047fabe30d9ab")
    public Result p62396079e4b047fabe30d9abDo(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = deleteRevenueRecognitionService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
