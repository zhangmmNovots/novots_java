...
public class QueryRevenueConfirmationToDisplayItemListController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private QueryRevenueConfirmationToDisplayItemListService queryRevenueConfirmationToDisplayItemListService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p6237ec56e4b02961f8302336")
    public Result p6237ec56e4b02961f8302336Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = queryRevenueConfirmationToDisplayItemListService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
