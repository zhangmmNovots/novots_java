...
public class SignInController {
    ...
    * @return
    */
    @PostMapping(value = "/v1/p622dc3f9e4b04cba1c7023a4")
    public Result p622dc3f9e4b04cba1c7023a4Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = signInService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
