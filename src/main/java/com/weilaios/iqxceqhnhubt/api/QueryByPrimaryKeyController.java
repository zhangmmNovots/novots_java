...
public class QueryByPrimaryKeyController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private QueryByPrimaryKeyService queryByPrimaryKeyService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p62394177e4b02961f8302442")
    public Result p62394177e4b02961f8302442Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            //调用执行流程方法
            JSONObject returnDataJson = queryByPrimaryKeyService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
