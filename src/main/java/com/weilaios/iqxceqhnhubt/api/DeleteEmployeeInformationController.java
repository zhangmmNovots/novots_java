...
public class DeleteEmployeeInformationController {
    private transient Logger log = LoggerFactory.getLogger(getClass());
    @Autowired
    private DeleteEmployeeInformationService deleteEmployeeInformationService;
    ...
    * @return
    */
    @PostMapping(value = "/v1/p62319fb7e4b0bf5b63a21e60")
    public Result p62319fb7e4b0bf5b63a21e60Do(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject params) {
        log.info("===============流程执行开始=======");
        ...
        try {
            ...
            BeeUtils.isEmpty("主键", paramMapList.get("id"));
            //组装流程执行的系统默认参数
            ...
            //调用执行流程方法
            JSONObject returnDataJson = deleteEmployeeInformationService.processMainExecute(dataJson);
            //移除过程执行中的临时变量
